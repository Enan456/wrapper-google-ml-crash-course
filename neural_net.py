...
cDataset = pd.read_csv("https://download.mlcc.google.com/mledu-datasets/california_housing_train.csv", sep=",")

cDataset = cDataset.reindex(
    np.random.permutation(cDataset.index))

#set customs
outputTargetVal = "median_house_value"
cPeriods = 50
cShuffle = 10000
...
def preprocess_features(cDataset):
  ...
  processed_features["rooms_per_person"] = (cDataset["total_rooms"] /cDataset["population"])
...
def preprocess_targets(cDataset):
  ...
  output_targets[outputTargetVal] = (cDataset[outputTargetVal] / 1000.0)
  return output_targets



# Choose the first 12000 (out of 17000) examples for training.
training_examples = preprocess_features(cDataset.head(12000))
training_targets = preprocess_targets(cDataset.head(12000))

# Choose the last 5000 (out of 17000) examples for validation.
validation_examples = preprocess_features(cDataset.tail(5000))
validation_targets = preprocess_targets(cDataset.tail(5000))
